...
module PriorProposal
  ...
  real(fp_kind), parameter :: mu_Bb    = 0.0d0, sigma_Bb    = 1.0d-8
  real(fp_kind), parameter :: mu_H     = 0.5d-5, sigma_H     = 1.0d-6
  real(fp_kind), parameter :: mu_E0    = 2480.0d0, sigma_E0    = 5.0d0
  real(fp_kind), parameter :: mu_Gamma = 1.0d-2, sigma_Gamma = 1.0d-3
  
  ! Prior parameters for white-line (WL) function:
  real(fp_kind), parameter :: mu_A_WL       = 0.0d0, sigma_A_WL       = 1.0d-6
  real(fp_kind), parameter :: mu_mu_WL      = 0.0d0, sigma_mu_WL      = 1.0d-1
  real(fp_kind), parameter :: mu_sigma_G_WL = 2.0d-1, sigma_sigma_G_WL = 0.5d-2
  real(fp_kind), parameter :: mu_gamma_L_WL = 2.0d-1, sigma_gamma_L_WL = 0.5d-2
  
  ! Prior parameters for each low-energy peak:
  real(fp_kind), parameter :: mu_low_A       = 0.0d0, sigma_low_A       = 1.0d-6
  real(fp_kind), parameter :: mu_low_mu      = 0.0d0, sigma_low_mu      = 2.0d0
  real(fp_kind), parameter :: mu_low_sigma_G = 2.0d-1, sigma_low_sigma_G = 0.5d-2
  real(fp_kind), parameter :: mu_low_gamma_L = 2.0d-1, sigma_low_gamma_L = 0.5d-2
  
  ! Prior parameters for each high-energy peak:
  real(fp_kind), parameter :: mu_high_A       = 0.0d0, sigma_high_A       = 1.0d-7
  real(fp_kind), parameter :: mu_high_mu      = 0.0d0, sigma_high_mu      = 2.0d0
  real(fp_kind), parameter :: mu_high_sigma_G = 2.0d-1, sigma_high_sigma_G = 0.5d-2
  real(fp_kind), parameter :: mu_high_gamma_L = 2.0d-1, sigma_high_gamma_L = 0.5d-2
